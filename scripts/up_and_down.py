#this is up and down py reference code 
...
#up and down flyer class which inherits from this drone superclass (drone) is what is used for saying from superclass
# the super class is provided by udacity  
class UpAndDownFlyer(Drone):

    #this intializer is the contructor for the class
    ...
    #this function is what is used to implement any logic that is particular to the particular flight plan that is happening 
